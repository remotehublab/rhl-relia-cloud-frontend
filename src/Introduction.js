...
function Introduction() {
    ...
    return (
        <Container className={"introduction-container"}>
            ...
            <ol>
                <li>In <a href="https://www.gnuradio.org/" target="_blank">GNU Radio</a>, you can build two files, one for a transmitter and one for a receiver. </li>
                {deviceName === "ADALM Pluto" && (
                    <li>You can use blocks that are QT widgets (Frequency Sink, Vector Sink, and others), as well as Pluto SDR blocks (PlutoSDR Source and PlutoSDR Sink). You can find an <a href="https://raw.githubusercontent.com/remotehublab/rhl-relia-gr-runner/main/examples/test_tx.grc" target="_blank">example transmitter</a> and an <a href="https://raw.githubusercontent.com/remotehublab/rhl-relia-gr-runner/main/examples/test_rx.grc" target="_blank">example receiver file</a>.</li>
                )}
                {deviceName === "Red Pitaya" && (
                    <li>You can use blocks that are QT widgets (Frequency Sink, Vector Sink, and others), as well as Red Pitaya SDR blocks (RedPitayaSDR Source and RedPitayaSDR Sink). You can find an <a href="https://raw.githubusercontent.com/remotehublab/rhl-relia-gr-runner/refs/heads/main/examples/test_tx_redpitaya.grc" target="_blank">example transmitter</a> and an <a href="https://raw.githubusercontent.com/remotehublab/rhl-relia-gr-runner/refs/heads/main/examples/test_rx_redpitaya.grc" target="_blank">example receiver file</a>.</li>
                )}
